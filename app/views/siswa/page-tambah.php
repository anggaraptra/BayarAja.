    ...
    <div class="content form-add add-siswa">
        <form action="<?= BASEURL ?>/siswa/add" method="POST">
            <div class="input-group">
                ...
                <input type="text" name="nis" id="nis" class="form-control" placeholder="ex:5320" maxlength="4" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
            </div>

            <div class="input-group">
                <label for="nama">Nama Lengkap</label>
                <input type="text" name="nama_siswa" id="nama_siswa" class="form-control" placeholder="ex:I Kadek Putra Anggara" required>
            </div>
            ...
            <div class="input-group">
                ...
                <input type="number" name="telp_ortu" id="telp_ortu" class="form-control" placeholder="ex:089680897900" maxlength="15" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
            </div>
